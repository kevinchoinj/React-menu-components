...
class MenuContent extends React.Component{
  ...
  render(){
    ...
    const oneSubmenuName = classNames(
      'fifteen_submenu_panel',
      {
        'fifteen_submenu_panel--display': submenuOne,
      }
    );
    const twoSubmenuName = classNames(
      'fifteen_submenu_panel',
      {
        'fifteen_submenu_panel--display': submenuTwo,
      }
    );
    const threeSubmenuName = classNames(
      'fifteen_submenu_panel',
      {
        'fifteen_submenu_panel--display': submenuThree,
      }
    );
    const fourSubmenuName = classNames(
      'fifteen_submenu_panel',
      {
        'fifteen_submenu_panel--display': submenuFour,
      }
    );
    const menuTitleName = classNames(
      'fifteen_menu_title',
      {
        'fifteen_menu_title--scrolled': scrolledPage,
      }
    );
    const menuValues = [
      {
    ...
    return(
      <div className="fifteen_menu_content">
              ...
              <div className={value.panelName}>
                {menuOneValues.map((value, index)=>(
                  <div key={index}>
                    <Link
                      to={value.link}
                      className="fifteen_submenu_link"
                    >
                      {value.text}
                    </Link>
                  </div>
